...
This file lives in `examples/v42/client/` and runs against a v41
stack; identical code lives in `examples/v42/client/` and
`examples/v43/client/` (only the version-pinned `dhis2w_client.v{N}`
import differs).

Usage:
    uv run python examples/v42/client/aggregate_bulk_grouped.py
...
from dhis2w_client.v42 import DataValue, Dhis2Client
