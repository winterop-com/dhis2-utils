...
Usage:
    DHIS2_PAT=... uv run python examples/v43/client/library_only_auth.py
    # or
    DHIS2_USERNAME=admin DHIS2_PASSWORD=district uv run python examples/v43/client/library_only_auth.py
"""
