...
| [`metadata_search.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/metadata_search.sh) | Cross-resource UID / code / name search via `dhis2 metadata search <query>` | [metadata plugin](architecture/metadata-plugin.md) |
| [`attribute_values.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/attribute_values.sh) | Cross-resource `AttributeValue` workflows via `dhis2 metadata attribute` | [metadata plugin](architecture/metadata-plugin.md) |
| [`options.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/options.sh) | `OptionSet` + `Option` workflows — `dhis2 metadata options show / find / sync` | [metadata plugin](architecture/metadata-plugin.md) |
| [`legend_sets.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/legend_sets.sh) | `dhis2 metadata legend-sets` — create / show / clone / delete + the seeded `LsDoseBand1` coverage dashboards | [legend sets API](api/legend-sets.md) |
| [`organisation_units.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/organisation_units.sh) | `dhis2 metadata organisation-units` + groups + group-sets + levels — tree walk, per-level rename, group + dimension round-trip | [organisation units API](api/organisation-units.md) |
| [`data_elements.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/data_elements.sh) | `dhis2 metadata data-elements` + groups + group-sets — DE create, rename, legend-set attach, group + dimension round-trip | [data elements API](api/data-elements.md) |
| [`indicators.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/indicators.sh) | `dhis2 metadata indicators` + groups + group-sets — numerator/denominator expression pre-flight, create, group + dimension round-trip | [indicators API](api/indicators.md) |
| [`program_indicators.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/program_indicators.sh) | `dhis2 metadata program-indicators` + groups — program-scoped expression validation + group membership (pair, no group-set) | [program indicators API](api/program-indicators.md) |
| [`category_options.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/category_options.sh) | `dhis2 metadata category-options` + groups + group-sets — validity-window creation + group + dimension round-trip | [category options API](api/category-options.md) |
| [`data_sets.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/data_sets.sh) | `dhis2 metadata data-sets` + `sections` — DataSet create, DE attach (with per-set CC override), ordered Section round-trip | [data sets API](api/data-sets.md) |
| [`messaging.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/messaging.sh) | `dhis2 messaging send / get / reply / set-priority / assign / delete` — ticket-workflow round-trip | [messaging plugin](architecture/messaging-plugin.md) |
| [`program_rules.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/program_rules.sh) | `dhis2 metadata program-rule` — vars, validate-expression, where-de-is-used | [metadata plugin](architecture/metadata-plugin.md) |
| [`sql_views.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/sql_views.sh) | `dhis2 metadata sql-view list / show / execute / refresh / adhoc` across the VIEW / QUERY / MATERIALIZED_VIEW shapes | [SQL views API](api/sql-views.md) |
...
| [`tracker_register_and_followup.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/tracker_register_and_followup.sh) | Canonical tracker-program clinic intake — register, log an event, query outstanding enrollments | [tracker](architecture/tracker.md) |
| [`tracker_event_program.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/tracker_event_program.sh) | Event-only WITHOUT_REGISTRATION program — standalone events with no enrollment | [tracker](architecture/tracker.md) |
...
| [`files.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/files.sh) | `dhis2 files` — documents (URL + binary round-trip) + fileResource (MESSAGE_ATTACHMENT round-trip) | [files plugin](architecture/files-plugin.md) |
...
| [`maps.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/maps.sh) | `dhis2 metadata map` — thematic choropleth authoring via REST | [maps API](api/maps.md) |
| [`map_screenshot.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/map_screenshot.sh) | `dhis2 browser map screenshot` — PNG capture via the Maps app (needs `[browser]` extra) | [maps API](api/maps.md) |
| [`apps.sh`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/cli/apps.sh) | `dhis2 apps list / hub-list / hub-url / update --dry-run / update --all / reload` over `/api/apps` + `/api/appHub` | [apps API](api/apps.md) |
...
| [`files_documents.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/files_documents.py) | **Cookbook** — `client.files` documents + fileResource round-trip; external URL docs, binary two-step upload, MESSAGE_ATTACHMENT round-trip | [files plugin](architecture/files-plugin.md) |
| [`bulk_delete.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/bulk_delete.py) | **Cookbook** — `client.metadata.delete_bulk` / `delete_bulk_multi` for one-call teardown via `/api/metadata?importStrategy=DELETE` | [metadata accessor](api/metadata-accessor.md) |
| [`bulk_save_and_dry_run.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/bulk_save_and_dry_run.py) | **Cookbook** — `client.resources.<res>.save_bulk(items)` for typed bulk create/update + `client.metadata.dry_run(...)` as the pre-commit safety gate | [metadata accessor](api/metadata-accessor.md) |
| [`stream_data_values.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/stream_data_values.py) | **Cookbook** — `client.data_values.stream` four ways: bytes, sync generator, Path (CSV), 1000-row file with timing | [data values streaming](api/data-values.md) |
| [`stream_analytics.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/stream_analytics.py) | **Cookbook** — `client.analytics.stream_to` for JSON / CSV / rawData exports to disk with per-format timing | [analytics streaming](api/analytics-stream.md) |
| [`messaging_with_attachment.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/messaging_with_attachment.py) | **Cookbook** — `client.messaging.send` + MESSAGE_ATTACHMENT fileResource pairing; full inbox lifecycle (list, reply, mark-read, delete) | [messaging plugin](architecture/messaging-plugin.md) |
| [`validation_and_predictors.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/validation_and_predictors.py) | **Cookbook** — `client.validation` + `client.predictors` workflow: expression validation, run analysis, list persisted results, run predictors | [validation API](api/validation.md) |
...
| [`oidc_login.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/oidc_login.py) | OAuth 2.1 authorization-code + PKCE flow; auto-dispatches to Playwright when `DHIS2_USERNAME`+`DHIS2_PASSWORD` are set | [auth](architecture/auth.md) |
| [`oidc_playwright_login.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/oidc_playwright_login.py) | Fully automated end-to-end OIDC via `drive_oauth2_login` — CLI subprocess + Chromium IdP form + consent screen | [auth](architecture/auth.md) / [browser](architecture/browser.md) |
...
| [`metadata_search.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/metadata_search.py) | Cross-resource UID / code / name search via `client.metadata.search` | [metadata plugin](architecture/metadata-plugin.md) |
| [`metadata_usage.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/metadata_usage.py) | Reverse-reference lookup "what points at this UID?" via `client.metadata.usage` | [metadata plugin](architecture/metadata-plugin.md) |
| [`attribute_values.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/attribute_values.py) | `AttributeValuesAccessor` across every resource with an `attributeValues` field | [metadata plugin](architecture/metadata-plugin.md) |
| [`options_integration.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/options_integration.py) | Every method on `OptionSetsAccessor` — list / show / find / sync | [metadata plugin](architecture/metadata-plugin.md) |
| [`legend_sets.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/legend_sets.py) | `client.legend_sets.create_from_spec` + `VisualizationSpec(legend_set=...)` — colour bands attached to a throw-away viz | [legend sets API](api/legend-sets.md) |
| [`organisation_units.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/organisation_units.py) | `client.organisation_units` + groups + group-sets + levels — descendants walk, rename-by-level, membership + dimension round-trip | [organisation units API](api/organisation-units.md) |
| [`data_elements.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/data_elements.py) | `client.data_elements` + groups + group-sets — keyword-arg create, rename, per-item membership, dimension | [data elements API](api/data-elements.md) |
| [`indicators.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/indicators.py) | `client.indicators.validate_expression` pre-flight + numerator/denominator create + group + dimension round-trip | [indicators API](api/indicators.md) |
| [`program_indicators.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/program_indicators.py) | `client.program_indicators` + groups — program-scoped expression validation + EVENT/ENROLLMENT create + group round-trip (pair, no group-set) | [program indicators API](api/program-indicators.md) |
| [`category_options.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/category_options.py) | `client.category_options` validity-window helper + groups + group-sets round-trip | [category options API](api/category-options.md) |
| [`data_sets.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/data_sets.py) | `client.data_sets` + `client.sections` — DataSet create, DE attach, ordered Section round-trip | [data sets API](api/data-sets.md) |
| [`program_rules.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/program_rules.py) | Every method on `ProgramRulesAccessor` — show, vars, validate, where-DE-used | [metadata plugin](architecture/metadata-plugin.md) |
| [`sql_views.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/sql_views.py) | `SqlViewsAccessor` list / show / execute / refresh / adhoc across the three view shapes | [SQL views API](api/sql-views.md) |
| [`sql_view_runner.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/sql_view_runner.py) | Three ways to use `SqlViewRunner` — by UID, ad-hoc query, named bindings | [SQL views API](api/sql-views.md) |
...
| [`tracker_clinic_intake.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/tracker_clinic_intake.py) | Canonical tracker-program intake via `client.tracker.register / add_event / outstanding` | [tracker](architecture/tracker.md) |
| [`tracker_event_program.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/tracker_event_program.py) | WITHOUT_REGISTRATION event-only program — one-shot events via `add_event` without an enrollment | [tracker](architecture/tracker.md) |
...
| [`apps.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/client/apps.py) | `client.apps.list_apps / hub_list / get_hub_url` — library surface for the apps plugin | [apps API](api/apps.md) |
...
| [`metadata_search.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/metadata_search.py) | `metadata_search` — cross-resource UID / code / name lookup for agents | [metadata plugin](architecture/metadata-plugin.md) |
| [`metadata_usage.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/metadata_usage.py) | `metadata_usage` — "what references this UID?" reverse lookup for agents | [metadata plugin](architecture/metadata-plugin.md) |
| [`legend_sets.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/legend_sets.py) | `metadata_legend_set_*` — list / create / show / delete via MCP | [legend sets API](api/legend-sets.md) |
| [`organisation_units.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/organisation_units.py) | `metadata_organisation_unit_*` — tree walk + levels + group + group-set via MCP | [organisation units API](api/organisation-units.md) |
| [`data_elements.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/data_elements.py) | `metadata_data_element_*` — DE + group + group-set round-trip via MCP | [data elements API](api/data-elements.md) |
| [`indicators.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/indicators.py) | `metadata_indicator_*` — expression validation + create + group + group-set via MCP | [indicators API](api/indicators.md) |
| [`program_indicators.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/program_indicators.py) | `metadata_program_indicator_*` — program-scoped expression + group round-trip via MCP | [program indicators API](api/program-indicators.md) |
| [`category_options.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/category_options.py) | `metadata_category_option_*` — validity window + group + group-set via MCP | [category options API](api/category-options.md) |
| [`data_sets.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/data_sets.py) | `metadata_data_set_*` + `metadata_section_*` — DataSet + Section round-trip via MCP | [data sets API](api/data-sets.md) |
...
| [`tracker_workflow.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/tracker_workflow.py) | Agent flow — `tracker_register`, `tracker_add_event`, `tracker_outstanding` for a tracker program | [tracker](architecture/tracker.md) |
...
| [`apps.py`](https://github.com/winterop-com/dhis2-utils/blob/main/examples/mcp/apps.py) | `apps_list`, `apps_hub_list` (plus `apps_install_*`, `apps_uninstall`, `apps_update{,_all}`, `apps_hub_url_{get,set}` available) | [apps API](api/apps.md) |
