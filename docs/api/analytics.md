...
- [Visualizations walkthrough](../guides/visualizations.md) — end-to-end guide showing how to go from a `client.analytics.query(...)` result to a saved chart + a dashboard slot.

::: dhis2w_client.analytics
