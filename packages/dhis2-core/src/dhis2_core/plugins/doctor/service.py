...
from dhis2_core.plugins.doctor.probes_bugs import BUGS_PROBES
from dhis2_core.plugins.doctor.probes_integrity import run_integrity_probes
from dhis2_core.plugins.doctor.probes_metadata import METADATA_PROBES
