...
def test_calendar_with_arg_and_yes_writes_setting(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with (
        patch("dhis2_core.plugins.system.service.get_calendar", new=AsyncMock(return_value="iso8601")),
        patch("dhis2_core.plugins.system.service.set_calendar", new=set_mock),
    ):
        runner = CliRunner()
