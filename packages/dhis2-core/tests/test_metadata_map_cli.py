...
from dhis2_client.generated.v42.schemas import Map
...
def test_map_list_renders_table(pat_profile: None) -> None:  # noqa: ARG001
    with patch(
        "dhis2_core.plugins.metadata.service.list_maps",
...
def test_map_create_forwards_every_flag(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2_core.plugins.metadata.service.create_map", new=mock):
...
def test_map_clone_forwards_new_name(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2_core.plugins.metadata.service.clone_map", new=mock):
        result = CliRunner().invoke(
            build_app(),
            [
                "metadata",
...
def test_map_delete_aborts_without_yes(pat_profile: None) -> None:  # noqa: ARG001
    with patch(
        "dhis2_core.plugins.metadata.service.delete_map",
