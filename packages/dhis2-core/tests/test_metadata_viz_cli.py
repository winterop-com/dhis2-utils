...
from dhis2_client.generated.v42.schemas import Dashboard, Visualization
...
def test_viz_list_renders_type_column(pat_profile: None) -> None:  # noqa: ARG001
    with patch(
        "dhis2_core.plugins.metadata.service.list_visualizations",
...
def test_viz_list_forwards_type_filter(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2_core.plugins.metadata.service.list_visualizations", new=mock):
...
def test_viz_create_forwards_every_flag(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2_core.plugins.metadata.service.create_visualization", new=mock):
...
def test_viz_clone_passes_new_name_and_new_uid(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2_core.plugins.metadata.service.clone_visualization", new=mock):
        result = CliRunner().invoke(
            build_app(),
            [
                "metadata",
...
def test_viz_delete_prompts_without_yes_flag(pat_profile: None) -> None:  # noqa: ARG001
    with patch(
        "dhis2_core.plugins.metadata.service.delete_visualization",
...
def test_dashboard_list_renders_uid_and_name(pat_profile: None) -> None:  # noqa: ARG001
    with patch(
        "dhis2_core.plugins.metadata.service.list_dashboards",
...
def test_dashboard_add_item_forwards_slot(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2_core.plugins.metadata.service.dashboard_add_item", new=mock):
        result = CliRunner().invoke(
            build_app(),
            [
                "metadata",
...
def test_dashboard_remove_item_reports_new_count(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch(
        "dhis2_core.plugins.metadata.service.dashboard_remove_item",
