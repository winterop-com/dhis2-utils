...
from dhis2_client.generated.v42.schemas import ProgramRule, ProgramRuleVariable
...
def test_program_rule_list_prints_priority_and_name(pat_profile: None) -> None:  # noqa: ARG001
    rules = [_rule()]
    with patch("dhis2_core.plugins.metadata.service.list_program_rules", new=AsyncMock(return_value=rules)):
...
def test_program_rule_vars_for_surfaces_source_type(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch(
        "dhis2_core.plugins.metadata.service.list_program_rule_variables",
...
def test_program_rule_validate_expression_exits_1_on_error(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch(
        "dhis2_core.plugins.metadata.service.validate_program_rule_expression",
...
def test_program_rule_where_de_is_used_exits_1_on_miss(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch(
        "dhis2_core.plugins.metadata.service.program_rules_using_data_element",
