...
from dhis2_client.generated.v42.schemas import TrackedEntityAttribute, TrackedEntityType
...
def test_tea_list_renders_value_type_column(pat_profile: None) -> None:  # noqa: ARG001
    with patch(
        "dhis2_core.plugins.metadata.service.list_tracked_entity_attributes",
...
def test_tea_create_forwards_flags(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2_core.plugins.metadata.service.create_tracked_entity_attribute", new=mock):
...
def test_tea_delete_skips_confirm_with_yes(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2_core.plugins.metadata.service.delete_tracked_entity_attribute", new=mock):
        result = CliRunner().invoke(
            build_app(),
...
def test_tet_list_renders_attributes_count(pat_profile: None) -> None:  # noqa: ARG001
    with patch(
        "dhis2_core.plugins.metadata.service.list_tracked_entity_types",
...
def test_tet_create_forwards_every_flag(pat_profile: None) -> None:  # noqa: ARG001
    ...
    with patch("dhis2_core.plugins.metadata.service.create_tracked_entity_type", new=mock):
        result = CliRunner().invoke(
            build_app(),
            [
                "metadata",
...
def test_tet_add_attribute_routes_to_service(pat_profile: None) -> None:  # noqa: ARG001
    mock = AsyncMock(return_value=_tet())
    with patch("dhis2_core.plugins.metadata.service.add_tracked_entity_type_attribute", new=mock):
        result = CliRunner().invoke(
            build_app(),
            [
                "metadata",
...
def test_tet_remove_attribute_routes_to_service(pat_profile: None) -> None:  # noqa: ARG001
    mock = AsyncMock(return_value=_tet())
    with patch("dhis2_core.plugins.metadata.service.remove_tracked_entity_type_attribute", new=mock):
        result = CliRunner().invoke(
            build_app(),
...
def test_tet_delete_skips_confirm_with_yes(pat_profile: None) -> None:  # noqa: ARG001
    mock = AsyncMock(return_value=None)
    with patch("dhis2_core.plugins.metadata.service.delete_tracked_entity_type", new=mock):
        result = CliRunner().invoke(
            build_app(),
