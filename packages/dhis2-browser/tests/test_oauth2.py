"""Unit tests for `dhis2_browser.oauth2._read_auth_url` — stderr-parser contract."""
...
import pytest
from dhis2_browser.oauth2 import _read_auth_url
...
def test_oauth2_login_result_is_frozen_pydantic_model() -> None:
    ...
    from dhis2_browser.oauth2 import OAuth2LoginResult
