...
`dhis2_client.categories`; the auto-generated `CategoryOptionCombo`
matrix is exposed read-only in `dhis2_client.category_option_combos`.
...
from dhis2_client.generated.v42.schemas import CategoryCombo
