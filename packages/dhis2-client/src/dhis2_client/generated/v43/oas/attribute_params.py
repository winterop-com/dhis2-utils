...
class AttributeParamsCreatedBy(_BaseModel):
    """OpenAPI schema `AttributeParamsCreatedBy`."""
...
class AttributeParamsLastUpdatedBy(_BaseModel):
    """OpenAPI schema `AttributeParamsLastUpdatedBy`."""
...
class AttributeParamsOptionSet(_BaseModel):
    """OpenAPI schema `AttributeParamsOptionSet`."""
...
class AttributeParams(_BaseModel):
    """OpenAPI schema `AttributeParams`."""
    ...
    createdBy: AttributeParamsCreatedBy | None = None
    ...
    lastUpdatedBy: AttributeParamsLastUpdatedBy | None = None
    legendSetAttribute: bool | None = None
    mandatory: bool | None = None
    mapAttribute: bool | None = None
    name: str | None = None
    optionAttribute: bool | None = None
    optionSet: AttributeParamsOptionSet | None = None
