"""Generated SMSCommand model for DHIS2 v43. Do not edit by hand."""
...
class SMSCommand(BaseModel):
    ...
    DHIS2 S M S Command - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/smsCommands.
