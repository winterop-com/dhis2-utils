"""Generated OptionSet model for DHIS2 v43. Do not edit by hand."""
...
class OptionSet(BaseModel):
    ...
    DHIS2 Option Set - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/optionSets.
