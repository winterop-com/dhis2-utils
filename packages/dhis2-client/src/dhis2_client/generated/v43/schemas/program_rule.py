"""Generated ProgramRule model for DHIS2 v43. Do not edit by hand."""
...
class ProgramRule(BaseModel):
    """Generated model for DHIS2 `ProgramRule`.

    DHIS2 Program Rule - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/programRules.
