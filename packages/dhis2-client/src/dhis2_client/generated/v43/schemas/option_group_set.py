"""Generated OptionGroupSet model for DHIS2 v43. Do not edit by hand."""
...
class OptionGroupSet(BaseModel):
    """Generated model for DHIS2 `OptionGroupSet`.

    DHIS2 Option Group Set - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/optionGroupSets.
    ...
    optionGroups: list[Any] | None = Field(default=None, description="Collection of OptionGroup.")
