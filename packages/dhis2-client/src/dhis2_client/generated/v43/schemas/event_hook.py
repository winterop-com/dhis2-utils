"""Generated EventHook model for DHIS2 v43. Do not edit by hand."""
...
class EventHook(BaseModel):
    ...
    DHIS2 Event Hook - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/eventHooks.
