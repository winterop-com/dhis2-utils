"""Generated ProgramIndicator model for DHIS2 v43. Do not edit by hand."""
...
class ProgramIndicator(BaseModel):
    ...
    DHIS2 Program Indicator - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/programIndicators.
