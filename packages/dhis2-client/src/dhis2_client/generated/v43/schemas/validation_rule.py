"""Generated ValidationRule model for DHIS2 v43. Do not edit by hand."""
...
class ValidationRule(BaseModel):
    ...
    DHIS2 Validation Rule - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/validationRules.
