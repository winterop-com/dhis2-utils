"""Generated UserGroup model for DHIS2 v43. Do not edit by hand."""
...
class UserGroup(BaseModel):
    ...
    DHIS2 User Group - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/userGroups.
