"""Generated Category model for DHIS2 v43. Do not edit by hand."""
...
class Category(BaseModel):
    ...
    DHIS2 Category - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/categories.
