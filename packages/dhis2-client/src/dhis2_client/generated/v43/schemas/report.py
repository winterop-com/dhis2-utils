"""Generated Report model for DHIS2 v43. Do not edit by hand."""
...
class Report(BaseModel):
    ...
    DHIS2 Report - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/reports.
