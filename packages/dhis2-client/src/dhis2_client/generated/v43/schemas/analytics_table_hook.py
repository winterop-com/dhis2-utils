"""Generated AnalyticsTableHook model for DHIS2 v43. Do not edit by hand."""
...
class AnalyticsTableHook(BaseModel):
    ...
    DHIS2 Analytics Table Hook - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/analyticsTableHooks.
