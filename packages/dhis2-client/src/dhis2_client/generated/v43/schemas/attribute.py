"""Generated Attribute model for DHIS2 v43. Do not edit by hand."""
...
class Attribute(BaseModel):
    ...
    DHIS2 Attribute - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/attributes.
