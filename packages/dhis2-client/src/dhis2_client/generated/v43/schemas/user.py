"""Generated User model for DHIS2 v43. Do not edit by hand."""
...
class User(BaseModel):
    ...
    DHIS2 User - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/users.
