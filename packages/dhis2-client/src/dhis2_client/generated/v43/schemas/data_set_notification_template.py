"""Generated DataSetNotificationTemplate model for DHIS2 v43. Do not edit by hand."""
...
class DataSetNotificationTemplate(BaseModel):
    """Generated model for DHIS2 `DataSetNotificationTemplate`.

    DHIS2 Data Set Notification Template - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/dataSetNotificationTemplates.
