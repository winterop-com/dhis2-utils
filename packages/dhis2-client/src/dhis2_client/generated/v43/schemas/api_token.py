"""Generated ApiToken model for DHIS2 v43. Do not edit by hand."""
...
class ApiToken(BaseModel):
    ...
    DHIS2 Api Token - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/apiToken.
