"""Generated OrganisationUnitGroup model for DHIS2 v43. Do not edit by hand."""
...
class OrganisationUnitGroup(BaseModel):
    ...
    DHIS2 Organisation Unit Group - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/organisationUnitGroups.
