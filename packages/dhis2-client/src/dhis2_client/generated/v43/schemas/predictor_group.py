"""Generated PredictorGroup model for DHIS2 v43. Do not edit by hand."""
...
class PredictorGroup(BaseModel):
    ...
    DHIS2 Predictor Group - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/predictorGroups.
