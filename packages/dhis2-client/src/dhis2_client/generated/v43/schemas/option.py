"""Generated Option model for DHIS2 v43. Do not edit by hand."""
...
class Option(BaseModel):
    ...
    DHIS2 Option - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/options.
