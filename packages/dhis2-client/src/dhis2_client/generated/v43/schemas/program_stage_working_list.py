"""Generated ProgramStageWorkingList model for DHIS2 v43. Do not edit by hand."""
...
class ProgramStageWorkingList(BaseModel):
    ...
    DHIS2 Program Stage Working List - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/programStageWorkingLists.
