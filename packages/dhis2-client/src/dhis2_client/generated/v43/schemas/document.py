"""Generated Document model for DHIS2 v43. Do not edit by hand."""
...
class Document(BaseModel):
    ...
    DHIS2 Document - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/documents.
