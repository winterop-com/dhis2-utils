"""Generated ProgramSection model for DHIS2 v43. Do not edit by hand."""
...
class ProgramSection(BaseModel):
    """Generated model for DHIS2 `ProgramSection`.

    DHIS2 Program Section - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/programSections.
    ...
    trackedEntityAttributes: list[Any] | None = Field(default=None, description="Collection of TrackedEntityAttribute.")
