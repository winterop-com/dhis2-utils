"""Generated JobConfiguration model for DHIS2 v43. Do not edit by hand."""
...
class JobConfiguration(BaseModel):
    ...
    DHIS2 Job Configuration - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/jobConfigurations.
