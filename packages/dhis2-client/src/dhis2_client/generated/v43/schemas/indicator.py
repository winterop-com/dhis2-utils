"""Generated Indicator model for DHIS2 v43. Do not edit by hand."""
...
class Indicator(BaseModel):
    ...
    DHIS2 Indicator - persisted metadata (generated from /api/schemas at DHIS2 v43).

    API endpoint: /dev-2-43/api/indicators.
