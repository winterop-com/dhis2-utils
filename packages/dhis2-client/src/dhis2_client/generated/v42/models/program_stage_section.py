"""Generated ProgramStageSection model for DHIS2 v42. Do not edit by hand."""
...
class ProgramStageSection(BaseModel):
    """DHIS2 Program Stage Section - persisted metadata (generated from /api/schemas at DHIS2 v42).
