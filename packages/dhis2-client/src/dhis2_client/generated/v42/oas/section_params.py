...
class SectionParamsCreatedBy(_BaseModel):
    """OpenAPI schema `SectionParamsCreatedBy`."""
...
class SectionParamsLastUpdatedBy(_BaseModel):
    """OpenAPI schema `SectionParamsLastUpdatedBy`."""
...
class SectionParams(_BaseModel):
    ...
    createdBy: SectionParamsCreatedBy | None = None
    ...
    lastUpdatedBy: SectionParamsLastUpdatedBy | None = None
    name: str | None = None
