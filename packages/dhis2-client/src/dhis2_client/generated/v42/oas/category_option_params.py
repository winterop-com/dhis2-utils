...
class CategoryOptionParamsLegendSet(_BaseModel):
    """OpenAPI schema `CategoryOptionParamsLegendSet`."""
...
class CategoryOptionParamsLegendSets(_BaseModel):
    """OpenAPI schema `CategoryOptionParamsLegendSets`."""
...
class CategoryOptionParams(_BaseModel):
    ...
    legendSet: CategoryOptionParamsLegendSet | None = None
    legendSets: list[CategoryOptionParamsLegendSets] | None = None
    name: str | None = None
