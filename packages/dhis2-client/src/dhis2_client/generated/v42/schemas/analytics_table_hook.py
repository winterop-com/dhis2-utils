"""Generated AnalyticsTableHook model for DHIS2 v42. Do not edit by hand."""
...
class AnalyticsTableHook(BaseModel):
    """DHIS2 Analytics Table Hook - persisted metadata (generated from /api/schemas at DHIS2 v42).
