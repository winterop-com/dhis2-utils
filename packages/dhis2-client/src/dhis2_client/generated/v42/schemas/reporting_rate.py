"""Generated ReportingRate model for DHIS2 v42. Do not edit by hand."""
...
from ..enums import AggregationType, DimensionItemType, ReportingRateMetric


class ReportingRate(BaseModel):
    """Generated model for DHIS2 `ReportingRate`.

    DHIS2 Reporting Rate - DHIS2 resource (generated from /api/schemas at DHIS2 v42).
