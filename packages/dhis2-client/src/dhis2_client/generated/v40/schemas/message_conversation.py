"""Generated MessageConversation model for DHIS2 v40. Do not edit by hand."""
...
class MessageConversation(BaseModel):
    ...
    DHIS2 Message Conversation - DHIS2 resource (generated from /api/schemas at DHIS2 v40).
