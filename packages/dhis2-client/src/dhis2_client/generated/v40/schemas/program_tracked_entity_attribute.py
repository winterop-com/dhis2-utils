"""Generated ProgramTrackedEntityAttribute model for DHIS2 v40. Do not edit by hand."""
...
class ProgramTrackedEntityAttribute(BaseModel):
    ...
    DHIS2 Program Tracked Entity Attribute - DHIS2 resource (generated from /api/schemas at DHIS2 v40).
