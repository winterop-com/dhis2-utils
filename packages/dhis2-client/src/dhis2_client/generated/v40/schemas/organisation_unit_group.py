"""Generated OrganisationUnitGroup model for DHIS2 v40. Do not edit by hand."""
...
class OrganisationUnitGroup(BaseModel):
    """DHIS2 Organisation Unit Group - persisted metadata (generated from /api/schemas at DHIS2 v40).
