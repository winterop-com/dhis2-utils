"""Generated ExpressionDimensionItem model for DHIS2 v40. Do not edit by hand."""
...
class ExpressionDimensionItem(BaseModel):
    """DHIS2 Expression Dimension Item - persisted metadata (generated from /api/schemas at DHIS2 v40).
