"""Generated TrackedEntityAttribute model for DHIS2 v40. Do not edit by hand."""
...
class TrackedEntityAttribute(BaseModel):
    ...
    DHIS2 Tracked Entity Attribute - persisted metadata (generated from /api/schemas at DHIS2 v40).
