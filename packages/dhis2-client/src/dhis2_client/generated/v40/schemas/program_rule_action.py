"""Generated ProgramRuleAction model for DHIS2 v40. Do not edit by hand."""
...
class ProgramRuleAction(BaseModel):
    """DHIS2 Program Rule Action - persisted metadata (generated from /api/schemas at DHIS2 v40).
