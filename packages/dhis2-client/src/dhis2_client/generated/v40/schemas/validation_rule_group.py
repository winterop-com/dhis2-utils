"""Generated ValidationRuleGroup model for DHIS2 v40. Do not edit by hand."""
...
class ValidationRuleGroup(BaseModel):
    """DHIS2 Validation Rule Group - persisted metadata (generated from /api/schemas at DHIS2 v40).
