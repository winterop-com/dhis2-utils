"""Generated ProgramSection model for DHIS2 v40. Do not edit by hand."""
...
class ProgramSection(BaseModel):
    ...
    DHIS2 Program Section - persisted metadata (generated from /api/schemas at DHIS2 v40).


    API endpoint: /api/programSections.
