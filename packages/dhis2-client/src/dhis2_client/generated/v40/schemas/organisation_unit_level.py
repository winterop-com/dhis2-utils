"""Generated OrganisationUnitLevel model for DHIS2 v40. Do not edit by hand."""
...
class OrganisationUnitLevel(BaseModel):
    ...
    DHIS2 Organisation Unit Level - persisted metadata (generated from /api/schemas at DHIS2 v40).
