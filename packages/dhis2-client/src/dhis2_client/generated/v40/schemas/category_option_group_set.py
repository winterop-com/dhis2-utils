"""Generated CategoryOptionGroupSet model for DHIS2 v40. Do not edit by hand."""
...
class CategoryOptionGroupSet(BaseModel):
    """DHIS2 Category Option Group Set - persisted metadata (generated from /api/schemas at DHIS2 v40).
