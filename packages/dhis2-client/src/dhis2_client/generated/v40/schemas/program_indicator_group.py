"""Generated ProgramIndicatorGroup model for DHIS2 v40. Do not edit by hand."""
...
class ProgramIndicatorGroup(BaseModel):
    """DHIS2 Program Indicator Group - persisted metadata (generated from /api/schemas at DHIS2 v40).
    ...
    members: list[Any] | None = Field(default=None, description="Collection of ProgramIndicator.")
