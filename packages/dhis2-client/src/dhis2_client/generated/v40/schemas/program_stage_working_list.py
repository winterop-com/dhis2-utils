"""Generated ProgramStageWorkingList model for DHIS2 v40. Do not edit by hand."""
...
class ProgramStageWorkingList(BaseModel):
    ...
    DHIS2 Program Stage Working List - persisted metadata (generated from /api/schemas at DHIS2 v40).
