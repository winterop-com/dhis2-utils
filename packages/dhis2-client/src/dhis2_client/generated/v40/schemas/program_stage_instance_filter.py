"""Generated ProgramStageInstanceFilter model for DHIS2 v40. Do not edit by hand."""
...
class ProgramStageInstanceFilter(BaseModel):
    """Generated model for DHIS2 `ProgramStageInstanceFilter`.
