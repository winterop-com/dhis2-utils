"""Generated DatastoreEntry model for DHIS2 v40. Do not edit by hand."""
...
class DatastoreEntry(BaseModel):
    """Generated model for DHIS2 `DatastoreEntry`.

    DHIS2 Datastore Entry - DHIS2 resource (generated from /api/schemas at DHIS2 v40).
    ...
    key: str | None = Field(default=None, description="Length/value max=255.")
