"""Generated DataEntryForm model for DHIS2 v40. Do not edit by hand."""
...
class DataEntryForm(BaseModel):
    """DHIS2 Data Entry Form - persisted metadata (generated from /api/schemas at DHIS2 v40).
    ...
    format: int | None = Field(default=None, description="Length/value max=2147483647.")

    href: str | None = None

    htmlCode: str | None = Field(default=None, description="Length/value max=2147483647.")

    lastUpdated: datetime | None = None

    lastUpdatedBy: Reference | None = Field(default=None, description="Reference to User.")

    name: str | None = Field(default=None, description="Unique. Length/value max=160.")
