...
class UserRole(BaseModel):
    """Generated model for DHIS2 `UserRole`.

    DHIS2 User Role - persisted metadata (generated from /api/schemas at DHIS2 v44).


    API endpoint: /dev/api/userRoles.
    ...
    restrictions: list[Any] | None = Field(default=None, description="Collection of Set. Read-only (inverse side).")
