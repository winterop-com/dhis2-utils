"""Generated ProgramRuleVariable model for DHIS2 v44. Do not edit by hand."""
...
class ProgramRuleVariable(BaseModel):
    """DHIS2 Program Rule Variable - persisted metadata (generated from /api/schemas at DHIS2 v44).

    API endpoint: /dev/api/programRuleVariables.
