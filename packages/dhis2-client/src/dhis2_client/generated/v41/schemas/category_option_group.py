"""Generated CategoryOptionGroup model for DHIS2 v41. Do not edit by hand."""
...
class CategoryOptionGroup(BaseModel):
    ...
    DHIS2 Category Option Group - persisted metadata (generated from /api/schemas at DHIS2 v41).
