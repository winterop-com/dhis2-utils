"""Generated RelationshipConstraint model for DHIS2 v41. Do not edit by hand."""
...
class RelationshipConstraint(BaseModel):
    ...
    DHIS2 Relationship Constraint - DHIS2 resource (generated from /api/schemas at DHIS2 v41).
