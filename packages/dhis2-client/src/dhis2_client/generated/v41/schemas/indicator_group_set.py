"""Generated IndicatorGroupSet model for DHIS2 v41. Do not edit by hand."""
...
class IndicatorGroupSet(BaseModel):
    ...
    DHIS2 Indicator Group Set - persisted metadata (generated from /api/schemas at DHIS2 v41).
