"""Generated TrackedEntityType model for DHIS2 v41. Do not edit by hand."""
...
class TrackedEntityType(BaseModel):
    ...
    DHIS2 Tracked Entity Type - persisted metadata (generated from /api/schemas at DHIS2 v41).
