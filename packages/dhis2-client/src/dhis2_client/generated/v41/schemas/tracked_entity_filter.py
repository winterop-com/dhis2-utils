"""Generated TrackedEntityFilter model for DHIS2 v41. Do not edit by hand."""
...
class TrackedEntityFilter(BaseModel):
    ...
    DHIS2 Tracked Entity Filter - persisted metadata (generated from /api/schemas at DHIS2 v41).
