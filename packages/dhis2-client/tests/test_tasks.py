...
async def test_await_completion_returns_final_notification(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    route = respx.get("https://dhis2.example/api/system/tasks/ANALYTICS_TABLE/uid123").mock(
        side_effect=[
            _notifications(
                [
                    {"uid": "n1", "time": "t1", "level": "INFO", "message": "starting", "completed": False},
                    {"uid": "n2", "time": "t2", "level": "INFO", "message": "halfway", "completed": False},
                ]
            ),
            _notifications(
                [
                    {"uid": "n1", "time": "t1", "level": "INFO", "message": "starting", "completed": False},
                    {"uid": "n2", "time": "t2", "level": "INFO", "message": "halfway", "completed": False},
                    {"uid": "n3", "time": "t3", "level": "INFO", "message": "all done", "completed": True},
                ]
            ),
        ]
    )
