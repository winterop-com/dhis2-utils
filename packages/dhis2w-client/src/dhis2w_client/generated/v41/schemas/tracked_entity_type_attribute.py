"""Generated TrackedEntityTypeAttribute model for DHIS2 v41. Do not edit by hand."""
...
class TrackedEntityTypeAttribute(BaseModel):
    ...
    DHIS2 Tracked Entity Type Attribute - DHIS2 resource (generated from /api/schemas at DHIS2 v41).
