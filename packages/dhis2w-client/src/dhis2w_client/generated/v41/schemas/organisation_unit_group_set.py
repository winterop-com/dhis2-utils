"""Generated OrganisationUnitGroupSet model for DHIS2 v41. Do not edit by hand."""
...
class OrganisationUnitGroupSet(BaseModel):
    ...
    DHIS2 Organisation Unit Group Set - persisted metadata (generated from /api/schemas at DHIS2 v41).
