"""Generated Constant model for DHIS2 v41. Do not edit by hand."""
...
class Constant(BaseModel):
    """Generated model for DHIS2 `Constant`.

    DHIS2 Constant - persisted metadata (generated from /api/schemas at DHIS2 v41).
