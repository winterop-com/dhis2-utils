"""Generated Event model for DHIS2 v41. Do not edit by hand."""
...
class Event(BaseModel):
    """Generated model for DHIS2 `Event`.

    DHIS2 Event - DHIS2 resource (generated from /api/schemas at DHIS2 v41).
    ...
    notes: list[Any] | None = Field(default=None, description="Collection of Note.")
