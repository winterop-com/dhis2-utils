"""Generated DHIS2 v40 StrEnums. Do not edit by hand."""
...
class AccessLevel(StrEnum):
    """org.hisp.dhis.common.AccessLevel (DHIS2 v40)."""
...
class AggregationType(StrEnum):
    """org.hisp.dhis.analytics.AggregationType (DHIS2 v40)."""
...
class AnalyticsFavoriteType(StrEnum):
    """org.hisp.dhis.analytics.AnalyticsFavoriteType (DHIS2 v40)."""
...
class AnalyticsPeriodBoundaryType(StrEnum):
    """org.hisp.dhis.program.AnalyticsPeriodBoundaryType (DHIS2 v40)."""
...
class AnalyticsTablePhase(StrEnum):
    """org.hisp.dhis.analytics.AnalyticsTablePhase (DHIS2 v40)."""
...
class AnalyticsTableType(StrEnum):
    """org.hisp.dhis.analytics.AnalyticsTableType (DHIS2 v40)."""
...
class AnalyticsType(StrEnum):
    """org.hisp.dhis.program.AnalyticsType (DHIS2 v40)."""
...
class ApiTokenType(StrEnum):
    """org.hisp.dhis.security.apikey.ApiTokenType (DHIS2 v40)."""

    PERSONAL_ACCESS_TOKEN = "PERSONAL_ACCESS_TOKEN"


class Attribute(StrEnum):
    """org.hisp.dhis.eventvisualization.Attribute (DHIS2 v40)."""
...
class CacheStrategy(StrEnum):
    """org.hisp.dhis.common.cache.CacheStrategy (DHIS2 v40)."""
...
class CompletenessMethod(StrEnum):
    """org.hisp.dhis.sms.command.CompletenessMethod (DHIS2 v40)."""
...
class DashboardItemShape(StrEnum):
    """org.hisp.dhis.dashboard.DashboardItemShape (DHIS2 v40)."""
...
class DashboardItemType(StrEnum):
    """org.hisp.dhis.dashboard.DashboardItemType (DHIS2 v40)."""
...
class DataDimensionType(StrEnum):
    """org.hisp.dhis.common.DataDimensionType (DHIS2 v40)."""
...
class DataElementDomain(StrEnum):
    """org.hisp.dhis.dataelement.DataElementDomain (DHIS2 v40)."""
...
class DataSetNotificationRecipient(StrEnum):
    """org.hisp.dhis.dataset.notifications.DataSetNotificationRecipient (DHIS2 v40)."""
...
class DataSetNotificationTrigger(StrEnum):
    """org.hisp.dhis.dataset.notifications.DataSetNotificationTrigger (DHIS2 v40)."""
...
class DigitGroupSeparator(StrEnum):
    """org.hisp.dhis.common.DigitGroupSeparator (DHIS2 v40)."""
...
class DimensionItemType(StrEnum):
    """org.hisp.dhis.common.DimensionItemType (DHIS2 v40)."""
...
class DimensionType(StrEnum):
    """org.hisp.dhis.common.DimensionType (DHIS2 v40)."""
...
class DisplayDensity(StrEnum):
    """org.hisp.dhis.common.DisplayDensity (DHIS2 v40)."""
...
class EventDataType(StrEnum):
    """org.hisp.dhis.analytics.EventDataType (DHIS2 v40)."""
...
class EventOutputType(StrEnum):
    """org.hisp.dhis.analytics.EventOutputType (DHIS2 v40)."""
...
class EventStatus(StrEnum):
    """org.hisp.dhis.event.EventStatus (DHIS2 v40)."""
...
class EventVisualizationType(StrEnum):
    """org.hisp.dhis.eventvisualization.EventVisualizationType (DHIS2 v40)."""
...
class FeatureType(StrEnum):
    """org.hisp.dhis.organisationunit.FeatureType (DHIS2 v40)."""
...
class FileResourceDomain(StrEnum):
    """org.hisp.dhis.fileresource.FileResourceDomain (DHIS2 v40)."""
...
class FileResourceStorageStatus(StrEnum):
    """org.hisp.dhis.fileresource.FileResourceStorageStatus (DHIS2 v40)."""
...
class FontSize(StrEnum):
    """org.hisp.dhis.common.FontSize (DHIS2 v40)."""
...
class FormType(StrEnum):
    """org.hisp.dhis.dataset.FormType (DHIS2 v40)."""
...
class HideEmptyItemStrategy(StrEnum):
    """org.hisp.dhis.common.HideEmptyItemStrategy (DHIS2 v40)."""
...
class ImageFormat(StrEnum):
    """org.hisp.dhis.mapping.ImageFormat (DHIS2 v40)."""
...
class Importance(StrEnum):
    """org.hisp.dhis.validation.Importance (DHIS2 v40)."""
...
class JobStatus(StrEnum):
    """org.hisp.dhis.scheduling.JobStatus (DHIS2 v40)."""
...
class JobType(StrEnum):
    """org.hisp.dhis.scheduling.JobType (DHIS2 v40)."""
...
class LegendDisplayStrategy(StrEnum):
    """org.hisp.dhis.legend.LegendDisplayStrategy (DHIS2 v40)."""
...
class LegendDisplayStyle(StrEnum):
    """org.hisp.dhis.legend.LegendDisplayStyle (DHIS2 v40)."""
...
class MapLayerPosition(StrEnum):
    """org.hisp.dhis.mapping.MapLayerPosition (DHIS2 v40)."""
...
class MapService(StrEnum):
    """org.hisp.dhis.mapping.MapService (DHIS2 v40)."""
...
class MapViewRenderingStrategy(StrEnum):
    """org.hisp.dhis.mapping.MapViewRenderingStrategy (DHIS2 v40)."""
...
class MappingEventStatus(StrEnum):
    """org.hisp.dhis.mapping.EventStatus (DHIS2 v40)."""
...
class MessageConversationPriority(StrEnum):
    """org.hisp.dhis.message.MessageConversationPriority (DHIS2 v40)."""
...
class MessageConversationStatus(StrEnum):
    """org.hisp.dhis.message.MessageConversationStatus (DHIS2 v40)."""
...
class MessageType(StrEnum):
    """org.hisp.dhis.message.MessageType (DHIS2 v40)."""
...
class MetadataProposalStatus(StrEnum):
    """org.hisp.dhis.metadata.MetadataProposalStatus (DHIS2 v40)."""
...
class MetadataProposalTarget(StrEnum):
    """org.hisp.dhis.metadata.MetadataProposalTarget (DHIS2 v40)."""

    ORGANISATION_UNIT = "ORGANISATION_UNIT"


class MetadataProposalType(StrEnum):
    """org.hisp.dhis.metadata.MetadataProposalType (DHIS2 v40)."""
...
class MissingValueStrategy(StrEnum):
    """org.hisp.dhis.expression.MissingValueStrategy (DHIS2 v40)."""
...
class NormalizedOutlierMethod(StrEnum):
    """org.hisp.dhis.visualization.NormalizedOutlierMethod (DHIS2 v40)."""

    Y_RESIDUALS_LINEAR = "Y_RESIDUALS_LINEAR"


class NotificationTrigger(StrEnum):
    """org.hisp.dhis.program.notification.NotificationTrigger (DHIS2 v40)."""
...
class NumberType(StrEnum):
    """org.hisp.dhis.analytics.NumberType (DHIS2 v40)."""
...
class Operator(StrEnum):
    """org.hisp.dhis.expression.Operator (DHIS2 v40)."""
...
class OrganisationUnitDescendants(StrEnum):
    """org.hisp.dhis.common.OrganisationUnitDescendants (DHIS2 v40)."""
...
class OrganisationUnitSelectionMode(StrEnum):
    """org.hisp.dhis.common.OrganisationUnitSelectionMode (DHIS2 v40)."""
...
class OutlierMethod(StrEnum):
    """org.hisp.dhis.visualization.OutlierMethod (DHIS2 v40)."""
...
class ParserType(StrEnum):
    """org.hisp.dhis.sms.parse.ParserType (DHIS2 v40)."""
...
class Position(StrEnum):
    """org.hisp.dhis.dashboard.design.Position (DHIS2 v40)."""
...
class ProgramNotificationRecipient(StrEnum):
    """org.hisp.dhis.program.notification.ProgramNotificationRecipient (DHIS2 v40)."""
...
class ProgramRuleActionEvaluationTime(StrEnum):
    """org.hisp.dhis.programrule.ProgramRuleActionEvaluationTime (DHIS2 v40)."""
...
class ProgramRuleActionType(StrEnum):
    """org.hisp.dhis.programrule.ProgramRuleActionType (DHIS2 v40)."""
...
class ProgramRuleVariableSourceType(StrEnum):
    """org.hisp.dhis.programrule.ProgramRuleVariableSourceType (DHIS2 v40)."""
...
class ProgramStatus(StrEnum):
    """org.hisp.dhis.program.ProgramStatus (DHIS2 v40)."""
...
class ProgramType(StrEnum):
    """org.hisp.dhis.program.ProgramType (DHIS2 v40)."""
...
class RegressionType(StrEnum):
    """org.hisp.dhis.common.RegressionType (DHIS2 v40)."""
...
class RelationshipEntity(StrEnum):
    """org.hisp.dhis.relationship.RelationshipEntity (DHIS2 v40)."""
...
class ReportType(StrEnum):
    """org.hisp.dhis.report.ReportType (DHIS2 v40)."""
...
class ReportingRateMetric(StrEnum):
    """org.hisp.dhis.common.ReportingRateMetric (DHIS2 v40)."""
...
class ResourceTableType(StrEnum):
    """org.hisp.dhis.resourcetable.ResourceTableType (DHIS2 v40)."""
...
class SchedulingType(StrEnum):
    """org.hisp.dhis.scheduling.SchedulingType (DHIS2 v40)."""
...
class SendStrategy(StrEnum):
    """org.hisp.dhis.notification.SendStrategy (DHIS2 v40)."""
...
class SqlViewType(StrEnum):
    """org.hisp.dhis.sqlview.SqlViewType (DHIS2 v40)."""
...
class ThematicMapType(StrEnum):
    """org.hisp.dhis.mapping.ThematicMapType (DHIS2 v40)."""
...
class UserOrgUnitType(StrEnum):
    """org.hisp.dhis.common.UserOrgUnitType (DHIS2 v40)."""
...
class ValidationStrategy(StrEnum):
    """org.hisp.dhis.program.ValidationStrategy (DHIS2 v40)."""
...
class ValueType(StrEnum):
    """org.hisp.dhis.common.ValueType (DHIS2 v40)."""
...
class VersionType(StrEnum):
    """org.hisp.dhis.metadata.version.VersionType (DHIS2 v40)."""
...
class VisualizationType(StrEnum):
    """org.hisp.dhis.visualization.VisualizationType (DHIS2 v40)."""
