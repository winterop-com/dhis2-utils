"""Generated User model for DHIS2 v40. Do not edit by hand."""
...
class User(BaseModel):
    ...
    DHIS2 User - persisted metadata (generated from /api/schemas at DHIS2 v40).
    ...
    settings: str | None = Field(
        default=None, description="Reference to UserSettings. Read-only (inverse side). Length/value max=2147483647."
    )
