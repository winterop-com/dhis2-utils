"""Generated EventChart model for DHIS2 v44. Do not edit by hand."""
...
class EventChart(BaseModel):
    ...
    DHIS2 Event Chart - persisted metadata (generated from /api/schemas at DHIS2 v44).

    API endpoint: /dev/api/eventCharts.
