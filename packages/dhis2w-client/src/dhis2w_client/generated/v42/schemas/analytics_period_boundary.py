"""Generated AnalyticsPeriodBoundary model for DHIS2 v42. Do not edit by hand."""
...
class AnalyticsPeriodBoundary(BaseModel):
    ...
    DHIS2 Analytics Period Boundary - DHIS2 resource (generated from /api/schemas at DHIS2 v42).
