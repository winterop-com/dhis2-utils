"""Generated OptionGroupSet model for DHIS2 v42. Do not edit by hand."""
...
class OptionGroupSet(BaseModel):
    ...
    DHIS2 Option Group Set - persisted metadata (generated from /api/schemas at DHIS2 v42).

    API endpoint: /api/optionGroupSets.
