...
class OrganisationUnit(_BaseModel):
    ...
    organisationUnitGroups: list[BaseIdentifiableObject] | None = None
    parent: BaseIdentifiableObject | None = None
    path: str | None = None
    phoneNumber: str | None = None
    programs: list[BaseIdentifiableObject] | None = None
