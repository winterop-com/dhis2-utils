...
class SystemSettings(_BaseModel):
    ...
    keyDataImportRequireCategoryOptionCombo: bool | None = None
    keyDataImportStrictAttributeOptionCombos: bool | None = None
    keyDataImportStrictCategoryOptionCombos: bool | None = None
    keyDataImportStrictDataElements: bool | None = None
    keyDataImportStrictDataSetApproval: bool | None = None
    keyDataImportStrictDataSetInputPeriods: bool | None = None
