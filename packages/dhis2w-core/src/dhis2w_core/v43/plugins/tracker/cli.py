...
def register_command(
    ...
    if tet is None:
        from dhis2w_core.v43.client_context import open_client  # noqa: PLC0415 — scoped to fallback path
...
def outstanding_command(
    ...
    """
    from dhis2w_core.v43.cli_output import ColumnSpec, render_list
